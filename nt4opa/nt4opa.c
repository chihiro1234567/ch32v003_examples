...
int main(){
	...
	GPIOC->CFGLR |= (GPIO_Speed_10MHz | GPIO_CNF_OUT_PP)<<(4*pin_no);
	...
	uint16_t counter = 0;
	//uint16_t maxlimit = 120;//temp=230
	//uint16_t maxlimit = 197;//temp=200
	uint16_t maxlimit = 185;
	uint16_t vin = 0;
	uint16_t opout = 0;
	while(1){
		Delay_Ms(interval);
